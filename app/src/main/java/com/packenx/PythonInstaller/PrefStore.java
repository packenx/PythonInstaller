package com.packenx.PythonInstaller;
...
class PrefStore {
    ...
    private static final String LOG_FILE = "PythonInstaller.log";
    ...
    /**
     * Get directory of Python installation
     *
     * @param c context
     * @return path, e.g. /data/data/com.example.app/files
     */
    ...
    /**
     * Create symlink is enabled
     *
     * @param c context
     * @return true, if create symlink
     */
    static boolean isCreateSymlink(Context c) {
        SharedPreferences pref = c.getSharedPreferences(APP_PREF_NAME, Context.MODE_PRIVATE);
        return pref.getBoolean("symlink", c.getString(R.string.symlink).equals("true"));
    }
